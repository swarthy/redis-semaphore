...
describe('Mutex', () => {
  ...
  it('should be reusable', async () => {
    ...
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(identifier1)
    await mutex.release()
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
    ...
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(identifier2)
    await mutex.release()
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
    ...
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(identifier3)
    await mutex.release()
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
    await Promise.delay(100)
    expect(await client.getAsync('mutex:key')).to.be.eql(null)
